...
const DetailDiagnosis = () => {
  ...
  <div className="detaildiagnosis__details">
      ...
      <p><img src="https://www.greenlife.co.ke/wp-content/uploads/rice_blast.jpg" alt="" width="500px" height="250px"></img></p>
      ...
      <div className="detaildiagnosis__product">
          ...
          <div className="detaildiagnosis__productlist">
              <strong>Notes</strong>
              <p>Pesticides treatments are difficult since the larva is only active outside the palnt for a few days between egg hatch and tunneling activity. Watch for flat white egg masses on leaf surfaces, or use black-light insect traps to scout for adult females in mid-June.</p>
          </div>
      </div>
      ...
      <p><textarea rows={10} cols={70}>Write  your message here</textarea></p>
      <div className="detaildiagnosis">
